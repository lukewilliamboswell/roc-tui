...
const _SIZE_CHECK_union_ListSelection: () = assert!(core::mem::size_of::<union_ListSelection>() == 4);
const _ALIGN_CHECK_union_ListSelection: () = assert!(core::mem::align_of::<union_ListSelection>() == 4);

const _SIZE_CHECK_ListSelection: () = assert!(core::mem::size_of::<ListSelection>() == 8);
const _ALIGN_CHECK_ListSelection: () = assert!(core::mem::align_of::<ListSelection>() == 4);
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        unsafe {
            match self.discriminant {
                ...
                Selected => {
                    let field: &u32 = &self.payload.Selected;
...
impl ListSelection {
    ...
    pub fn unwrap_Selected(mut self) -> u32 {
...
impl ListSelection {
    ...
    pub fn Selected(payload: u32) -> Self {
        Self {
